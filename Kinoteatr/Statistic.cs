...
namespace Kinoteatr
{
    public partial class Statistic : Form
    {
        ...
        public Statistic(MainMenu mainMenuForm)
        {
            ...
            WebRequest request1 = WebRequest.Create("http://localhost:8080/stat/getSeance?title&MovieYear&duration&publisher&genre&limit=90&offset&SeanceYear&month&day&hour&hall_n");
